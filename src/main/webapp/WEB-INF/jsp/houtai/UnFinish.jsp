          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" >
	                      <li> 
		                      <a class="actives" href="findUnFinsh.action">
			   ...
			   <tbody>
		          <c:forEach items="${list}" var="file" varStatus="vs">  
			        <tr>   
		             ...
		             <c:choose>
			             <c:when test="${file.fplanday == 0}">
			             	<%-- <td align = "center"> ${file.fplanmin }</td>  --%>
		             	<td >将于今天 ${file.fplanhous} 点 ${file.fplanmin } 分打印完成</td> 
		        	  </c:when> 
				             <c:otherwise>
				           	 <%--  <td align = "center"> ${file.fplanmin }</td>  --%>
			           	  <td >将于明天 ${file.fplanhous} 点 ${file.fplanmin } 分打印完成</td> 
				             </c:otherwise>
				             </c:choose> 
				         </tr>  
						</c:forEach>  
